...
public class ActionsJNAImplemented implements KeyListener, MouseListener, ActionListener {

	IdlePCLockerJNAImplemented ipl;
	
	public ActionsJNAImplemented(IdlePCLockerJNAImplemented ipl){
		this.ipl = ipl;
		ShowAboutDialog();
	}
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getActionCommand().equals("Exit")) {
			ipl.sysTray.remove(ipl.trayIcon);
			ipl.dispose();
			System.exit(0);
